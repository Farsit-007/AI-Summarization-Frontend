...
import ViewArticle from "../Home/ViewArticle";
import SummarizeArticle from "../Home/SummarizeArticle";

export function ArticleCardWithActions({ article }: { article: IArticle }) {
  return (
